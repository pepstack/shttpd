...
struct worker
{
    ...
    struct shttpd_ctx_t *ctx;          /* Context reference          */
...
struct conn
{
    ...
    struct shttpd_ctx_t *ctx;         /* Context this conn belongs to */
...
struct shttpd_ctx_t {
    ...
    char    *options[SHOPTIONS_NUM];     /* Configurable options     */
...
{
    struct llhead       link;
    struct shttpd_ctx_t   *ctx;        /* Context that socket belongs */
...
extern void _shttpd_get_mime_type(struct shttpd_ctx_t *, const char *, int, struct vec *);
...
extern int    _shttpd_spawn_process(struct conn *c, const char *prog, char *envblk, char *envp[], int sock, const char *dir);

extern int  _shttpd_set_nt_service(struct shttpd_ctx_t *, const char *);
extern int  _shttpd_set_systray(struct shttpd_ctx_t *, const char *);
...
extern int  _shttpd_edit_passwords (const char *fname, const char *domain, const char *user, const char *pass);
